...
--
-- Host: localhost:3306
-- Generation Time: Apr 09, 2018 at 08:41 PM
...
(1, 1, 'Algebra Matricial ', NULL, NULL),
...
--
ALTER TABLE `Modificacion`
  MODIFY `ModifId` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
ALTER TABLE `Usuario`
  MODIFY `UsuarioId` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
